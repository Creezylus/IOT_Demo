...
\restrict kMY1Gov4l82EpqE9YRVspx6xsdrnNYhuCvEGcI6s4JBTUaCQmMt6uSa2povKWNt
...
--
-- Name: idx_metrics_unsynced; Type: INDEX; Schema: public; Owner: creezylus
--

CREATE INDEX idx_metrics_unsynced ON public.metrics USING btree (is_synced) WHERE (is_synced = false);


--
-- Name: idx_readings_unsynced; Type: INDEX; Schema: public; Owner: creezylus
--

CREATE INDEX idx_readings_unsynced ON public.sensor_readings USING btree (is_synced) WHERE (is_synced = false);


--
-- Name: idx_station_locations_unsynced; Type: INDEX; Schema: public; Owner: creezylus
--

CREATE INDEX idx_station_locations_unsynced ON public.station_locations USING btree (is_synced) WHERE (is_synced = false);
...
\unrestrict kMY1Gov4l82EpqE9YRVspx6xsdrnNYhuCvEGcI6s4JBTUaCQmMt6uSa2povKWNt
